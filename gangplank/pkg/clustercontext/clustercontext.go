...
func K8sInClusterClient() (*kubernetes.Clientset, string, error) {
	...
	if !khost || !kport {
		return nil, "", errors.ErrNotInCluster
	}
...
// GetInCluster returns the inCluster bool
func (c *Cluster) GetInCluster() bool {
	return c.InCluster
}

// GetPodmanSrvDir returns the podmanSrvDir string
func (c *Cluster) GetPodmanSrvDir() string {
	return c.podmanSrvDir
}
